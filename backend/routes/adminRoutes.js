...
router.patch('/users/:id', authMiddleware, requireAdmin, validate(updateUserSchema), updateUser);
router.delete('/users/:id', authMiddleware, requireAdmin, validate(deleteAccountSchema), deleteUser);
