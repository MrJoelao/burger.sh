  ...
  return html`
    ...
    <main class="console" aria-label="Burger.sh kitchen console">
      <header class="titlebar">
        ...
        ${showClock ? html`<div class="machine-state"><span class="pulse"></span> grill online<time id="clock">${time}</time></div>` : html`<div class="machine-state"><span class="pulse"></span> grill online</div>`}
      </header>
