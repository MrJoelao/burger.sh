...
export function ManagerShell({ children, title = 'manager-ops', subtitle = 'restaurant control' }) {
  ...
  return html`
    ...
    <main class="console management-shell" aria-label="Manager operations console">
      <${TitleBar} section=${title} context=${subtitle} status="manager online" links=${links} showClock=${true} />
      ...
      <div class="management-grid">
        ...
        <section class="workspace"><header class="workspace-head"><p>/ manager / ${title}</p><p>access <b>GRANTED</b></p></header><div>${children}</div></section>
      </div>
